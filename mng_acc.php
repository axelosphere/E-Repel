<?php
session_start();
require_once __DIR__ . '/db/db.php'; // $pdo is used now
...
#sidebar { min-width: 200px; max-width: 200px; transition: all 0.3s; }
...
<nav id="sidebar" class="bg-dark text-white vh-100 position-fixed shadow-sm">
    ...
    <ul class="nav flex-column mt-4">
        <li class="nav-item"><a class="nav-link text-white d-flex align-items-center px-3 py-2" href="index.php"><i class="bi bi-house fs-5 me-2"></i><span class="fw-medium">Dashboard</span></a></li>
        <li class="nav-item"><a class="nav-link text-white d-flex align-items-center px-3 py-2" href="reports.php"><i class="bi bi-bar-chart fs-5 me-2"></i><span class="fw-medium">Reports</span></a></li>
        <li class="nav-item"><a class="nav-link text-white d-flex align-items-center px-3 py-2" href="mng_acc.php"><i class="bi bi-person fs-5 me-2"></i><span class="fw-medium">Manage Account</span></a></li>
        <li class="nav-item mt-auto"><a class="nav-link text-white d-flex align-items-center px-3 py-2" href="db/logout.php"><i class="bi bi-box-arrow-right fs-5 me-2"></i><span class="fw-medium">Logout</span></a></li>
    </ul>
</nav>
                        ...
                        <table class="table table-striped table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="db/delete_user.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-outline-danger"><i class="bi bi-trash"></i> Delete</a>
...
<div class="modal fade" id="updateAccountModal" tabindex="-1">
    <div class="modal-dialog">
        <form method="post" action="db/update_user.php" class="modal-content">
            <div class="modal-header"><h5 class="modal-title">Update Account</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
            <div class="modal-body">
                <input type="hidden" name="id" id="updateUserId">
                <input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?>">
                <div class="mb-3"><label class="form-label">Username</label><input type="text" class="form-control" name="username" id="updateUsername" required></div>
                <div class="mb-3"><label class="form-label">New Password (leave blank to keep current)</label><input type="password" class="form-control" name="password"></div>
            </div>
            <div class="modal-footer"><button type="submit" name="update" class="btn btn-success">Update</button></div>
        </form>
    </div>
</div>
...
<div class="modal fade" id="addAccountModal" tabindex="-1">
    <div class="modal-dialog">
        <form method="post" action="" class="modal-content">
            ...
            <div class="modal-footer"><button type="submit" name="register" class="btn btn-success">Add Account</button></div>
        </form>
    </div>
</div>
